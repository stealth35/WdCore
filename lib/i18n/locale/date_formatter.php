 ...
 */
class WdLocaleDateFormatter extends WdObject
{
	/**
...
//		'l' => Special symbol for Chinese leap month, used in combination with M. Only used with the Chinese calendar.
	 ...
	 */
	public function __construct(WdLocale $locale)
	{
		$this->locale = $locale;
	}
	...
	protected function format_quarter(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for quarter must be "Q", "QQ", "QQQ", "QQQQ". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_standalone_quarter(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for stand-alone quarter must be "q", "qq", "qqq" or "qqqq". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_era(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for era must be "G", "GG", "GGG", "GGGG" or "GGGGG". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_month(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for month must be "M", "MM", "MMM", "MMMM". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_standalone_month(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for stand-alone month must be "L", "LL", "LLL" or "LLLL". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_week_of_year(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for week of year must be "w" or "ww". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_week_of_month(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for week in month must be "W". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_day_of_month(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for day of the month must be "d" or "dd". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_day_of_year(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for day in year must be "D", "DD" or "DDD". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_day_of_week_in_month(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for day in month must be "F". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_day_in_week(array $date, $pattern)
	{
		...
		throw new WdException('The pattern for day of the week must be "E", "EE", "EEE", "EEEE", "EEEEE", "e", "ee", "eee", "eeee", "eeeee", "c", "cccc" or "ccccc". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_hour12(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for 12 hour format must be "h" or "hh". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_hour24(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for 24 hour format must be "H" or "HH". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_hour_in_period(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for hour in AM/PM must be "K" or "KK". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_hour_in_day(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for hour in day must be "k" or "kk". Given: %given', array('%given' => $pattern));
	}
	...
	protected function format_minutes(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for minutes must be "m" or "mm".');
	}
	...
	protected function format_seconds(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for seconds must be "s" or "ss".');
	}
	...
	protected function format_timezone(array $date, $pattern, $length)
	{
		...
		throw new WdException('The pattern for time zone must be "z" or "v".');
	}
}